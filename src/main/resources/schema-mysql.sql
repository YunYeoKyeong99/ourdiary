CREATE DATABASE IF NOT EXISTS `ourdiary`;

-- https://github.com/spring-projects/spring-session/blob/2.2.1.RELEASE/spring-session-jdbc/src/main/resources/org/springframework/session/jdbc/schema-mysql.sql
...
CREATE TABLE `friend_link` (
  `seq` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `friend_linkcol` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
